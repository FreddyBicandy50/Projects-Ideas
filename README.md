...
<b>Goal:</b>This a natural language processing project
The idea is to create a webscraper which scrape texts from websites primary tag are "p" and "pre" the tool will fetch texts recursively for a number of deph note, moreover the second module is dataset generator which will clean and inject data inside a csv file sperated by input and target, the tool will reject non alphabet ascii and work on noise sentnces for the dataset, finaly the last part is a tokenizer module which it's turn to learn from the generated dataset and 
correct grammar for given senteces

<b>Learning Outcomes:</b> learn how to use the awsome tools of webscraping, generating a dataset for machine learning module , text tokenizeationa and data cleaning

<b>Possible Enhancements:</b> for this tool its best recommended to use predfined texts modules rather than create yours because it will take much time and its not efficent

<b>Google Collab:</b> <a href="https://colab.research.google.com/drive/1Mfpvtc8okKiGsS3eTgcawPqA64ehgyzc?authuser=0#scrollTo=ITjh3BZZI797" target="_blank">click here</a>
...
## <img align="center" width="8%" src="https://user-images.githubusercontent.com/25181517/192108895-20dc3343-43e3-4a54-a90e-13a4abbc57b9.png"/> Android Studio EduLine (Java)
...
## <img align="center" width="8%" src="https://user-images.githubusercontent.com/25181517/117201156-9a724800-adec-11eb-9a9d-3cd0f67da4bc.png"/> JavaFx Hospital Managment System (Java)
...
## <img align="center" width="8%" src="https://user-images.githubusercontent.com/25181517/192106073-90fffafe-3562-4ff9-a37e-c77a2da0ff58.png"/> AI Tic-Tac-Toe (C++)
